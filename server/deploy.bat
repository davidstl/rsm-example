...
call plink -ssh -i "%userprofile%/.ssh/rsm.ppk" ec2-user@ec2-18-219-26-183.us-east-2.compute.amazonaws.com "sudo docker run --name rsm -d -p 9306:9306 -p 9308:9308 braincloud/rsm"
